...
const EVENT_LABELS: Record<string, string> = {
  ...
  knowledge_opened: "Opened education",
  advisor_question_asked: "Asked an advisor question",
  swipe_choice: "Swiped on products",
  appointment_intent: "Showed appointment interest",
