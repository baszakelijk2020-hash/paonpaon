...
export function StorefrontNav({ slug }: { slug: string }) {
  ...
  return (
    <>
      <nav
        aria-label="Primary"
        className="glass-panel fixed inset-x-0 bottom-0 z-40 grid grid-cols-4 border-t border-[var(--color-stone-200)] pb-[env(safe-area-inset-bottom)]"
      >
        <Link
