-- Keep event-derived StyleProfile evidence replay-safe and prove its event
-- provenance belongs to the same customer, retailer and interaction source.

create unique index if not exists customer_style_evidence_source_concept_uidx
