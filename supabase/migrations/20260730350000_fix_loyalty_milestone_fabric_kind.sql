-- Fix sync_loyalty_milestones_for_order: metadata_concept_kind has no 'fabric'
-- label (canonical kind is fabric_collection). Invalid enum literal broke
-- demo seed whenever delivered/completed orders triggered advanced_fabric.
