-- FT-09: `20260812000000` accidentally double-escaped the PostgreSQL regex,
-- rejecting normalized https://www.pinterest.com/... URLs after their parent
-- message had already persisted. Keep uploads fail-closed; links are still
-- accepted only for HTTPS Pinterest hosts.
