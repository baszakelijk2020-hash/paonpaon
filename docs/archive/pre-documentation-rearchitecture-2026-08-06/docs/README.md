...
| 2    | Ratified PAON product contract | [NORTH_STAR.md](./NORTH_STAR.md), [FOUNDER_TOOL_BLUEPRINTS.md](./FOUNDER_TOOL_BLUEPRINTS.md), [DESIGN_PORTS.md](./DESIGN_PORTS.md) | Curated PAON destination; fixed founder-tool experience/system contracts; decision rights                         |
