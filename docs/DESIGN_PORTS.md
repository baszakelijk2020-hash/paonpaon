...
| Swipe deck                                 | `apps/customer/app/r/[slug]/swipe/swipe-deck.tsx`                                                   | **Hardened faithful foundation.** Source spacing/motion and real data remain; right-save is now idempotent and recoverable, keyboard save is connected, and database/reload/wishlist browser proof passes. Deck-version/resume, touch/reduced-motion parity and withdrawal/recompute proof remain. |
