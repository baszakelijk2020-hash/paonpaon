...
| CLI-007                | Unified customer For You page with deterministic ranking, reason codes, diversity, inventory awareness, and learning events                                                                                | For You                            | `@paon/domain` `rankForYouRecommendations`, `ForYouRepository`, Customer `/for-you` with learning events                                   | CLI-002, CLI-003, EDU-002                       | 7.6                  | Every recommendation exposes human reason copy and evidence; owned/rejected/irrelevant items suppressed                          | Done (7.6)                                                                                                |
