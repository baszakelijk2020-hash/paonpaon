...
- **Current queue item:** `7.5 Branches, shared calendar, and post-appointment
closeout`. Skip Stage 6 while blocked.
...
- **Exact next files/tests:** implement `7.5` branch/store timezone, shared
  calendar controls, and post-appointment closeout rectangles feeding
  provenance-aware facts. Do not invent Stage 6 payment/marketplace code.
