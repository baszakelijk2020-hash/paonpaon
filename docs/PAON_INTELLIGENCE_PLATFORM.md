...
- **Completed programme commits:** `dd695d5` authorized the Intelligence
  ...
  (PHASE 7.3 complete); Stage 7.4 lands sparse clienteling opportunities;
  Stage 7.5 lands branch calendar and post-appointment closeout.
...
- **Exact next files/tests:** implement `7.6` unified customer For You page
  with deterministic ranking, reason codes, impression/click/dismiss capture,
  and inventory-aware suppression. Do not invent Stage 6 payment/marketplace
  code.
...
| CLI-006                | Branches/stores, shared calendar, recurring moments, and post-appointment closeout rectangles feeding Self-Portrait                                                                                        | Calendar + closeout                | `retailer_branches` / `branch_calendar_entries` / `appointment_closeouts` + closeout UI                                                     | CLI-003, CLI-005, appointments                  | 7.5                  | Manager-controlled branch calendar; closeout answers become provenance-aware facts                                               | Done (7.5)                                                                                                |
