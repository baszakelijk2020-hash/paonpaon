...
- Metadata concepts/edges/assignments, append-only review evidence, retailer
  ...
  has StyleProfile evidence persistence. The repository still has no
...
| CUST-003               | Visible customer controls and advisor-safe, retailer-scoped access                                                                                                                                         | Customer + advisor intelligence    | Purpose-specific account controls, StyleProfile inspect/remove, and advisor reads of usable same-retailer consented signals exist; advisor brief later | CUST-001, CUST-002                        | 3.1–3.3              | Withdrawal stops new use and invokes retention rules; advisors see only consented same-retailer evidence                         | Partial (3.1–3.2)  |
