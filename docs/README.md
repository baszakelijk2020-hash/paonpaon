...
| 3    | Active engineering programme | [PAON_INTELLIGENCE_PLATFORM.md](./PAON_INTELLIGENCE_PLATFORM.md), [CAPABILITY_DISPOSITION.md](./CAPABILITY_DISPOSITION.md), [FOUNDER_TOOL_BLUEPRINTS.md](./FOUNDER_TOOL_BLUEPRINTS.md) | Traceability, target architecture, inherited-capability disposition, founder-tool implementation contracts, acceptance, resume state |
